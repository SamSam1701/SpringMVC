...
<div class="well well-small">
	...
	<div class="row">
		...
		<div class="control-group">
			...
			<div class="controls">
				  <form:input type="text" placeholder="Nhập Email" path="user"/>
			</div>
		</div>
		 <div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <form:input type="text" placeholder="Nhập số địa chỉ" path="address"/>
			</div>
		</div>
			<div class="control-group">
			<label class="control-label">Ghi chú<sup>*</sup></label>
			<div class="controls">
			  <form:input type="text" placeholder="Nhập ghi chú" path="note"/>
			</div>
		</div>
	<div class="control-group">
		<div class="controls">
